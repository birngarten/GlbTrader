...
public class DenemeWait {
    ...
    public void user_wait_until_the_page_loads() {
        WebDriverWait wait=new WebDriverWait(Driver.getDriver(),10); // wait  olusturuldu
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[.='Hello World!']")));  // bu text gorunuene kadar beklesin unutma bunu
    ...
    public void verify_the_Hello_World_text_is_visible() {
        ...
        Assert.assertTrue(helloWorld.getText().equals("Hello World!")); // istenirse  isDisplayed de olur
        // Assert.assertTrue(helloWorld.isDisplayed()); bu da olabilir
